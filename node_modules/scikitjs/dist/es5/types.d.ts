...
* ==========================================================================
*/
import { Scalar, Tensor1D, Tensor2D, TensorLike, Tensor, RecursiveArray, DataType } from '@tensorflow/tfjs-core/dist/index.d';
import { ModelCompileArgs, ModelFitArgs } from '@tensorflow/tfjs-layers/dist/index.d';
...
export interface SeriesInterface extends NDframeInterface {
    ...
    add(other: any | number | Array<number>, options?: {
        inplace?: boolean;
    }): any | void;
    sub(other: any | number | Array<number>, options?: {
        inplace?: boolean;
    }): any | void;
    mul(other: any | number | Array<number>, options?: {
        inplace?: boolean;
    }): any | void;
    div(other: any | number | Array<number>, options?: {
        inplace?: boolean;
    }): any | void;
    pow(other: any | number | Array<number>, options?: {
        inplace?: boolean;
    }): any | void;
    mod(other: any | number | Array<number>, options?: {
        inplace?: boolean;
    }): any | void;
    mean(): number;
    median(): number;
    ...
    get str(): any;
    get dt(): any;
    append(values: string | number | boolean | any | ArrayType1D, index: Array<number | string> | number | string, options?: {
        inplace?: boolean;
    }): any | void;
    toString(): string;
    and(other: any): any;
...
export interface DataFrameInterface extends NDframeInterface {
    ...
    add(other: any | any | number | number[], options?: {
        axis?: 0 | 1;
        inplace?: boolean;
    }): any | void;
    sub(other: any | any | number | number[], options?: {
        axis?: 0 | 1;
        inplace?: boolean;
    }): any | void;
    mul(other: any | any | number | number[], options?: {
        axis?: 0 | 1;
        inplace?: boolean;
    }): any | void;
    div(other: any | any | number | number[], options?: {
        axis?: 0 | 1;
        inplace?: boolean;
    }): any | void;
    pow(other: any | any | number | number[], options?: {
        axis?: 0 | 1;
        inplace?: boolean;
    }): any | void;
    mod(other: any | any | number | number[], options?: {
        axis?: 0 | 1;
        inplace?: boolean;
    }): any | void;
    mean(options?: {
    ...
    query(condition: any | Array<boolean>, options?: {
        inplace?: boolean;
    }): any | void;
    addColumn(column: string, values: any | ArrayType1D, options?: {
        inplace?: boolean;
    ...
    lt(other: any | any | number, options?: {
        axis?: 0 | 1;
    }): any;
    gt(other: any | any | number, options?: {
        axis?: 0 | 1;
    }): any;
    le(other: any | any | number, options?: {
        axis?: 0 | 1;
    }): any;
    ge(other: any | any | number, options?: {
        axis?: 0 | 1;
    }): any;
    ne(other: any | any | number, options?: {
        axis?: 0 | 1;
    }): any;
    eq(other: any | any | number, options?: {
        axis?: 0 | 1;
    }): any;
    ...
    append(newValues: ArrayType1D | ArrayType2D | any | any, index: Array<number | string> | number | string, options?: {
        inplace?: boolean;
    }): any | void;
    toString(): string;
    getDummies(options?: {
...
export { Tensor1D, Tensor2D, TensorLike, Tensor, ModelCompileArgs, ModelFitArgs, RecursiveArray, Scalar, DataType };
export declare type TypedArray = Float32Array | Int32Array | Uint8Array;
export declare type ScikitLike1D = TypedArray | number[] | boolean[] | string[];
export declare type ScikitLike2D = TypedArray[] | number[][] | boolean[][] | string[][];
export declare type Scikit1D = ScikitLike1D | Tensor1D | SeriesInterface;
export declare type Scikit2D = ScikitLike2D | Tensor2D | DataFrameInterface;
export declare type ScikitVecOrMatrix = Scikit1D | Scikit2D;
export declare type OptimizerTypes = 'sgd' | 'momentum' | 'adadelta' | 'rmsprop' | 'adamax' | 'adam' | 'adagrad';
export declare type LossTypes = 'meanSquaredError' | 'sigmoidCrossEntropy' | 'softmaxCrossEntropy' | 'logLoss' | 'huberLoss' | 'hingeLoss' | 'cosineDistance' | 'computeWeightedLoss' | 'absoluteDifference' | 'custom';
export declare type Initializers = 'Zeros' | 'Ones';
...
export declare type Iterable<K> = {
    [index: number]: K;
    length: number;
};
