 ...
 */
export function validateShuffleSplit(nSamples, testSize, trainSize, defaultTestSize = 0.1) {
    assert(trainSize === undefined || typeof trainSize === 'number', `Invalid value for trainSize: ${trainSize}. Must be number or undefined`);
    assert(testSize === undefined || typeof testSize === 'number', `Invalid value for testSize: ${testSize}. Must be number or undefined`);
 ...
 * ```
 */
export function trainTestSplit(X, y, testSize = 0.1, trainSize, randomState) {
