 ...
 */
export const createRng = (seed) => alea(seed?.toString());
/**
 ...
 */
export const randInt = (rand) => (from, until) => {
    if (from >= until) {
 ...
 */
export const lhs = (rand) => (nSamples, nFeatures) => {
...
export const shuffle = (rand) => (array) => {
    const _randInt = randInt(rand);
