 ...
 */
function polyfillUnique(tf) {
    // TODO: remove this method as soon as tfjs-node supports tf.unique
    if (tf.engine().backendNames().includes('tensorflow') &&
        ...
        tf.registerKernel({
            ...
            kernelFunc: (args) => {
                ...
                (0, typesUtils_1.assert)(Object.keys(types).includes(x.dtype), 'Unexpected dtype.');
                try {
                    const opAttrs = [
                        {
                            value: types[x.dtype],
...
exports.polyfillUnique = polyfillUnique;
