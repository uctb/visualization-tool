...
exports.SGDClassifier = void 0;
const utils_1 = require("../utils");
const OneHotEncoder_1 = require("../preprocessing/OneHotEncoder");
const typesUtils_1 = require("../typesUtils");
const mixins_1 = require("../mixins");
const tf_singleton_1 = require("../tf-singleton");
class SGDClassifier extends mixins_1.ClassifierMixin {
    model; //tf.Sequential
    modelFitArgs;
    modelCompileArgs;
    ...
    constructor({ modelFitArgs, modelCompileArgs, denseLayerArgs, optimizerType, lossType }) {
        ...
        this.oneHot = new OneHotEncoder_1.OneHotEncoder();
    }
     ...
     */
    async fit(X, y) {
        let XTwoD = (0, utils_1.convertToNumericTensor2D)(X);
        let yOneD = (0, utils_1.convertToNumericTensor1D_2D)(y);
    ...
    predictProba(X) {
        (0, typesUtils_1.assert)(this.model.layers.length > 0, 'Need to call "fit" before "predict"');
        let XTwoD = (0, utils_1.convertToNumericTensor2D)(X);
