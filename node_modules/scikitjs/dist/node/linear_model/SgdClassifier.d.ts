...
export declare class SGDClassifier extends ClassifierMixin {
    model: any;
    modelFitArgs: ModelFitArgs;
    modelCompileArgs: ModelCompileArgs;
    denseLayerArgs: any;
    ...
    constructor({ modelFitArgs, modelCompileArgs, denseLayerArgs, optimizerType, lossType }: SGDClassifierParams);
     ...
     */
    fit(X: Scikit2D, y: Scikit1D | Scikit2D): Promise<SGDClassifier>;
    /**
