...
exports.KNeighborsClassifier = void 0;
const KNeighborsBase_1 = require("./KNeighborsBase");
const utils_1 = require("../utils");
const tfUtils_1 = require("../tfUtils");
const scorers_1 = require("../model_selection/scorers");
 ...
 * ```
 */
class KNeighborsClassifier extends KNeighborsBase_1.KNeighborsBase {
    classes_;
    score = scorers_1.accuracy;
    ...
    async fit(X, labels) {
        ...
        const { values, indices } = tf.tidy(() => {
            const _labels = (0, utils_1.convertToTensor1D)(labels);
