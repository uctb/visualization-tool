...
class CappedMaxHeap {
    ...
    constructor(keys, vals) {
        ...
        (0, typesUtils_1.assert)(len > 0, 'new CappedMaxHeap(keys,vals): keys.length must be positive.');
        (0, typesUtils_1.assert)(len === vals.length, 'new CappedMaxHeap(keys,vals): keys.length must equal vals.length.');
        keys[0] = NaN;
        this._keys = keys;
        this._vals = vals;
        this._pos = len;
    ...
    sort() {
        ...
        (0, typesUtils_1.assert)(0 === _pos, 'CappedMaxHeap().sort(): Heap is not full yet.');
        const swap = (i, j) => {
            let _key = _keys[i];
            _keys[i] = _keys[j];
            _keys[j] = _key;
...
exports.CappedMaxHeap = CappedMaxHeap;
