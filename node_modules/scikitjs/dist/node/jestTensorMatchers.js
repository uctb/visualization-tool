...
exports.toBeAllGreaterNotClose = exports.toBeAllLessNotClose = exports.toBeAllGreaterOrClose = exports.toBeAllLessOrClose = exports.toBeAllCloseTo = exports.toBeAll = void 0;
...
function toBeAll(result, expect, { broadcast = true, allowEmpty = false }, description, match) {
    let tf = (0, tf_singleton_1.getBackend)();
    const { isNot } = this;
    const a = (0, typesUtils_1.isTensor)(result) ? result : tf.tensor(result);
    const b = (0, typesUtils_1.isTensor)(expect) ? expect : tf.tensor(expect);
    const msg = (msg) => () => `\nA: ${a.toString(true)}` +
        `\nB: ${b.toString(true)}` +
...
exports.toBeAll = toBeAll;
function toBeAllCloseTo(result, expect, params = {}) {
    return toBeAll.call(this, result, expect, params, 'close to', isClose(params));
}
exports.toBeAllCloseTo = toBeAllCloseTo;
function toBeAllLessOrClose(result, expect, params = {}) {
    return toBeAll.call(this, result, expect, params, 'close to or less than', isLessOrClose(params));
}
exports.toBeAllLessOrClose = toBeAllLessOrClose;
function toBeAllGreaterOrClose(result, expect, params = {}) {
    const le = isLessOrClose(params);
    return toBeAll.call(this, result, expect, params, 'close to or greater than', (x, y) => le(y, x));
}
exports.toBeAllGreaterOrClose = toBeAllGreaterOrClose;
function toBeAllLessNotClose(result, expect, params = {}) {
    return toBeAll.call(this, result, expect, params, 'less than not close to', isLessNotClose(params));
}
exports.toBeAllLessNotClose = toBeAllLessNotClose;
function toBeAllGreaterNotClose(result, expect, params = {}) {
    const le = isLessNotClose(params);
    return toBeAll.call(this, result, expect, params, 'greater than not close to', (x, y) => le(y, x));
}
exports.toBeAllGreaterNotClose = toBeAllGreaterNotClose;
expect.extend({
    toBeAllCloseTo,
    toBeAllLessOrClose,
    toBeAllLessNotClose,
