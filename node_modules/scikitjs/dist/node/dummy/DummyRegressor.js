 ...
 * ```
 */
class DummyRegressor extends mixins_1.RegressorMixin {
    strategy;
    constant;
    quantile;
    ...
    fit(X, y) {
        (0, typesUtils_1.assert)((0, typesUtils_1.isScikit1D)(y), 'y variable can not be converted to a 1D Tensor.');
        (0, typesUtils_1.assert)(['mean', 'median', 'constant', 'quantile'].includes(this.strategy), `Strategy ${this.strategy} not supported. We support 'mean', 'median', 'constant', and 'quantile'`);
        ...
        if (this.strategy === 'median') {
            this.constant = (0, mathjs_1.median)(newY.arraySync());
            return this;
        }
        if (this.strategy === 'quantile') {
            (0, typesUtils_1.assert)(typeof this.quantile === 'number' &&
                !isNaN(this.quantile) &&
                isFinite(this.quantile), 'quantile is not set to a number. Please set it to a value between 0 and 1 in the constructor');
            (0, typesUtils_1.assert)(this.quantile < 0 || this.quantile > 1, 'quantile must be set to a value between 0 and 1');
            this.constant = (0, mathjs_1.quantileSeq)(newY.arraySync(), this.quantile);
            return this;
        }
...
exports.DummyRegressor = DummyRegressor;
