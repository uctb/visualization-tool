  ...
  <div id="app">
    ...
    <div class="mainbox">
      <ul>
              ...
              <el-tab-pane>
                ...
                <div class="option" style="margin-bottom: 2rem;">
                  ...
                  <el-popover placement="top-start" width="535" trigger="hover" close-delay=50>
                    ...
                    <UploadButton @process-upload="inputprocess" type="stationinfo" ref="stationinfo"
                      slot="reference" />
                  </el-popover>
                </div>
                <div class="option" style="margin-bottom: 2rem;">
        ...
        <li>
          <div class="head1" style="font-weight: bold;font-size: 1.5rem; color: rgba(255,255,255,.7)">Error
            Visualization
          </div>
          <div class="bar">
            <div class="barbox2">
          ...
          <div v-if="this.isShow && this.flag" class="boxall" style="height: 55%; margin-bottom: 1%" id="bmap"
            ref="bmap"></div>
        ...
        <li>
          ...
          <!--时空数据/评价指标的分布-->
          <div class="boxall" style="height:50%; margin-bottom: 2%">
      ...
      statistics_bc_option: [
        {
          ...
          children: [
            {
              value: 'Residual Time Series',
              label: 'Residual Time Series',
            }
          ],
        }
      ],
